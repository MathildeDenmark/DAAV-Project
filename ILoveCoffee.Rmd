...
Caffeine <- c(33, 100, 66, 200, 99, 325, 66, 141, 66, 241, 33, 100, 50, 210, 66, 200, 66, 200, 66, 325, 66, 325, 99, 325, 136, 256, 2, 2)
df <- data.frame(Type.of.Coffee, Brand, Caffeine)

print(df)

# Reorder levels of Type.of.Coffee
df$Type.of.Coffee <- factor(df$Type.of.Coffee, levels = c("Decaf Coffee", "Single-Shot Espresso", "Frappuccino", "Cold Brew", "Cortado", "Double-Shot Espresso", "Iced Latte", "Latte", "Flat White", "Mocha", "Cappucino", "Triple-Shot Espresso", "Americano", "Filter/Brewed Coffee"))
